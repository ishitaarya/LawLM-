"""LawSuit LLM — decoder-only Transformer.

This module is intentionally explicit: attention, masking, transformer blocks,
normalization, loss, and generation are implemented directly with PyTorch.
"""
...
# Backward-compatible alias while the repository transitions from LawLM to LawSuit.
LawLM = LawSuitLLM
